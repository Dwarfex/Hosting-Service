...
<table border="0" cellpadding="0" cellspacing="0" width="1000" align="center">
  <tr>
   ...
   <div id="links">
   <ul>
      <li><a href="http://www.webspell-cms.org/index.php?site=forum" target="_blank" class="link1"></a></li>
      <li><a href="http://www.webspell-cms.org/index.php?site=license" target="_blank" class="link2"></a></li>
  ...
  <tr>
   ...
   $site = str_replace($invalide,' ',$site);
   	...
   	else include('visitor_statistic.php');
   }
   else include('visitor_statistic.php');
   ?></div>
   </td>

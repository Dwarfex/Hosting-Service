...
elseif($action=="edit") {
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      <td colspan="2"><input type="hidden" name="captcha_hash" value="'.$hash.'" /><input type="hidden" name="squadID" value="'.$squadID.'" /><input type="submit" name="saveedit" value="'.$_language->module['edit_squad'].'" /></td>
    </tr>
  </table>
  </form>';
}

...
if(mysql_num_rows($ergebnis)){
	...
	while($ds=mysql_fetch_array($ergebnis)) {
		...
		$gewonnen='<img src="styles/right/win.jpg" width="12" height="12" alt="win" style="padding:2px 0 0 7px" />';
		$verloren='<img src="styles/right/lose.jpg" width="12" height="12" alt="lose" style="padding:2px 0 0 7px" />';
		$unentschieden='<img src="styles/right/draw.jpg" width="12" height="12" alt="draw" style="padding:2px 0 0 7px" />';
		...
		if($homescr>$oppscr) $icon=''.$gewonnen.'';
		elseif($homescr<$oppscr) $icon=''.$verloren.'';
		else $icon=''.$unentschieden.'';
		...
		$name='';
        $res=safe_query("SELECT name FROM ".PREFIX."squads WHERE squadID='".$ds['squad']."'");

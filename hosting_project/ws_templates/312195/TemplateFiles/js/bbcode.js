...
function nav(id) {
 if(id == 1) {
  if( document.getElementById('infoinhalt').style.display == 'none' ) { 
  document.getElementById('infoinhalt').style.display = 'block'; 
  }
	document.getElementById('teamsinhalt').style.display = 'none';
    document.getElementById('comminhalt').style.display = 'none';
    document.getElementById('mediainhalt').style.display = 'none';
	document.getElementById('ainfos').className = 'aktiv';
	document.getElementById('ateams').className = '';
	document.getElementById('acomm').className = '';
    document.getElementById('amedia').className = '';	  
 } 
 else if(id == 2) {
  if( document.getElementById('teamsinhalt').style.display == 'none' ) { 
  document.getElementById('teamsinhalt').style.display = 'block'; 
  }
	document.getElementById('infoinhalt').style.display = 'none';
    document.getElementById('comminhalt').style.display = 'none';
    document.getElementById('mediainhalt').style.display = 'none';
	document.getElementById('ainfos').className = '';
	document.getElementById('ateams').className = 'aktiv';
	document.getElementById('acomm').className = '';
	document.getElementById('amedia').className = '';
 } 
 else if(id == 3) {
  if( document.getElementById('comminhalt').style.display == 'none' ) { 
  document.getElementById('comminhalt').style.display = 'block'; 
  }
    document.getElementById('infoinhalt').style.display = 'none';
    document.getElementById('teamsinhalt').style.display = 'none';
    document.getElementById('mediainhalt').style.display = 'none';
  ...
  if( document.getElementById('mediainhalt').style.display == 'none' ) { 
  document.getElementById('mediainhalt').style.display = 'block'; 
  }
	document.getElementById('infoinhalt').style.display = 'none';
    document.getElementById('teamsinhalt').style.display = 'none';
    document.getElementById('comminhalt').style.display = 'none';

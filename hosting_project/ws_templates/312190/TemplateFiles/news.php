...
<body>';
	...
	$rubricpic='<img src="images/news-rubrics/'.getrubricpic($ds['rubric']).'" alt="" style="border:1px solid #aaa; float:left; margin:5px;" />';
...
elseif($action=="archive") {
	...
	while($ds=mysql_fetch_array($result)) {
		...
		$rubricpic='<img src="'.$rubricpic_path.'" border="0" alt="" style="border:1px solid #aaa; float:left; margin:5px;" />';

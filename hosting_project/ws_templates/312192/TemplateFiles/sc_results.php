...
if(mysql_num_rows($ergebnis)){
  ...
  while($ds=mysql_fetch_array($ergebnis)) {
    ...
    if($n%2) {
		...
		if($homescr>$oppscr) $resultimg='slike/result_images/win.jpg';
		elseif($homescr<$oppscr) $resultimg='slike/result_images/lost.jpg';
		else $resultimg='slike/result_images/draw.jpg';

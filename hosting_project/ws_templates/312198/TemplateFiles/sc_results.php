...
if(mysql_num_rows($ergebnis)){
  ...
  while($ds=mysql_fetch_array($ergebnis)) {
    ...
    if($homescr>$oppscr) $result='<font color="'.$wincolor.'">'.$homescr.':'.$oppscr.'</font>';
		...
		if($homescr>$oppscr) $resultimg='<img src="images/resultpics/winimage.gif" border="0">';
	elseif($homescr<$oppscr) $resultimg='<img src="images/resultpics/looseimage.gif" border="0">';
	else $resultimg='<img src="images/resultpics/drawimage.gif" border="0">';

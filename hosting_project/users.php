  ...
  if($pages>1) {
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#DDDDDD">
      <tr>
        ...
        <td width="75%" class="title"><a href="admincenter.php?site=users&amp;type='.$type.'&amp;sort=nickname&amp;page='.$page.'&amp;type='.$type.'&amp;search='.$search.'"><b>'.$_language->module['nickname'].'</b></a></td>
       
        <td width="25%" class="title" colspan="2"><b>'.$_language->module['actions'].'</b></td>
      </tr>';
      ...
      if($i%2) { $td='td1'; }
		...
		if($ds['activated']=="1") $actions = '<input style="margin-top: 3px;" type="button" onclick="MM_goToURL(\'parent\',\'admincenter.php?site=members&amp;action=edit&amp;id='.$ds['userID'].'\');return document.MM_returnValue" value="'.$_language->module['rights'].'" />';
		else $actions = '';
